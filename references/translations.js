...
const translations = {
    en: {
        ...
        yourSection: {
            ...
            description: "Access comprehensive data sources and references used in the observatory"
        }
    },
    fr: {
        nav: {
        ...
        yourSection: {
            ...
            description: "Accédez aux sources de données complètes et références utilisées dans l'observatoire"
        }
    }
};
