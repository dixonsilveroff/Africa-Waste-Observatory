...
const translations = {
    en: {
        ...
        yourSection: {
            ...
            description: "Review existing waste management policies and regulations across Africa"
        }
    },
    fr: {
        nav: {
        ...
        // Page-specific translations
        yourSection: {
            title: "Politiques et Réglementations",
            description: "Examinez les politiques et réglementations existantes en matière de gestion des déchets en Afrique"
        }
    }
};
