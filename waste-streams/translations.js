...
const translations = {
    en: {
        ...
        yourSection: {
            title: "Waste Streams",
            description: "Analyze detailed data on various types of waste materials across Africa"
        }
    },
    fr: {
        nav: {
        ...
        yourSection: {
            ...
            description: "Analysez des données détaillées sur divers types de matériaux de déchets en Afrique"
        }
    }
};
