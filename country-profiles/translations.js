...
const countryData = {
    "nigeria": {
        overviewText: "Nigeria is Africa's most populous nation (200+ million) and one of the continent's fastest-urbanizing economies, generating approximately 32 million metric tons of solid waste annually—a figure projected to reach 107 million tons by 2050. <a class='cite-link' href='../references/#ref-what-a-waste-2-0-a-global-snapshot-of-solid-waste-management-to-2050' title='Source: World Bank – What a Waste 2.0'>↗</a> This rapid demographic and urban expansion has positioned the country at the center of Africa's waste management challenge, particularly in Lagos, where 13,000 tons of waste are generated daily with 60% remaining uncollected. <a class='cite-link' href='../references/#ref-improving-solid-waste-and-plastics-management-in-lagos-state-a-way-forward' title='Source: World Bank – Improving Solid Waste and Plastics Management in Lagos State'>↗</a> The informal waste sector handles 59.3% of national waste disposal, employing millions of workers known as Baban Bola and Omo Gbonla, yet these essential workers remain largely unrecognized and unprotected. <a class='cite-link' href='../references/#ref-solid-waste-management-in-nigeria-national-report' title='Source: NESREA – Solid Waste Management in Nigeria'>↗</a> Recent landmark developments include the Lagos State single-use plastic ban (July 1, 2025), the $116 million Phoenix Edison waste-to-energy facility set to process 500 tons daily and create 1,144 jobs, and a comprehensive national roadmap (2025-2040) developed with the World Bank. As consumption patterns evolve and cities expand beyond existing infrastructure, waste management has become a critical issue linking environmental protection, public health, and economic development—while also presenting significant opportunities for circular economy growth and job creation.",
        snapshot: [
        ...
        wasteGeneration: `<p>Nigeria generates approximately <strong>32 million metric tons</strong> of solid waste annually, with urban areas contributing about <strong>27.3 million tons</strong> per year. This figure is projected to rise to <strong>107 million tons by 2050</strong>. <a class="cite-link" href="../references/#ref-what-a-waste-2-0-a-global-snapshot-of-solid-waste-management-to-2050" title="Source: World Bank – What a Waste 2.0">↗</a></p>
        ...
        wasteCollection: `<p>Waste collection efficiency remains low, averaging <strong>20–30% nationally</strong>, and reaching <strong>41% in optimized urban areas</strong>. This gap has led to the rise of a large informal waste ecosystem that handles <strong>59.3% of national waste disposal</strong>. <a class="cite-link" href="../references/#ref-solid-waste-management-in-nigeria-national-report" title="Source: NESREA – Solid Waste Management in Nigeria">↗</a></p>
        ...
        <ul>
            <li><strong>Climate Change Act (2021):</strong> Net-zero emissions target by 2060 <a class="cite-link" href="../references/#ref-climate-change-act-of-nigeria" title="Source: Climate Change Act of Nigeria">↗</a></li>
            ...
            <li><strong>Lagos State Single-Use Plastic Ban (July 1, 2025):</strong> Prohibits styrofoam, straws, cutlery, and plates. Offenders risk business shutdown. <a class="cite-link" href="../references/#ref-lagos-state-single-use-plastic-ban-policy" title="Source: Lagos State Government">↗</a></li>
    ...
    "egypt": {
        ...
        <p>Egypt is Africa's largest generator of e-waste, contributing over <strong>20% of the continent's electronic waste</strong>. <a class="cite-link" href="../references/#ref-global-e-waste-monitor" title="Source: ITU – Global E-Waste Monitor">↗</a></p>`,
        ...
        policy: `<ul>
            <li><strong>Waste Management Regulation Law (Law No. 202 of 2020)</strong> <a class="cite-link" href="../references/#ref-law-no-202-of-2020-waste-management-regulation-law" title="Source: Government of Egypt">↗</a></li>
    ...
    "kenya": {
        overviewText: "Kenya is undergoing a radical shift toward a circular economy, driven by devolved governance, progressive legislation, and cutting-edge infrastructure investments. The country generates approximately 8 million tons of waste annually with a national collection rate of only 30%—a gap that has prompted ambitious transformation initiatives. <a class='cite-link' href='../references/#ref-what-a-waste-2-0-a-global-snapshot-of-solid-waste-management-to-2050' title='Source: World Bank – What a Waste 2.0'>↗</a> Waste management is a county-level responsibility under Kenya's devolved governance structure (47 counties), supported by national oversight through the Sustainable Waste Management Act (2022), EPR Regulations (2024), and the 'Five R's' framework (Refuse, Reduce, Reuse, Repurpose, Recycle). Major 2025-2026 infrastructure breakthroughs position Kenya as East Africa's innovation leader: Konza Technopolis launched Africa's first pneumatic waste collection system with a $9 million investment featuring 15 kilometers of underground vacuum pipes, 50 intake points, and 40 tons/day capacity—eliminating traditional collection trucks entirely. <a class='cite-link' href='../references/#ref-konza-technopolis-pneumatic-waste-collection-system-project' title='Source: Envac Group – Konza Technopolis'>↗</a> Even more significantly, President William Ruto officially commissioned a 45 MW Waste-to-Energy plant at the notorious Dandora dumpsite on February 8, 2026, transforming East Africa's largest and most hazardous landfill into a clean energy generation hub. <a class='cite-link' href='../references/#ref-nairobi-waste-to-energy-power-plant-initiative-review' title='Source: ENVACO – Nairobi WtE Review'>↗</a> Combined with initiatives like HyaPak (converting invasive water hyacinth into biodegradable packaging) and textile take-back hubs addressing the 'mitumba crisis' (22.5 million kg of annual second-hand clothing imports), Kenya is demonstrating how technology, political will, and circular economy principles can revolutionize waste management.",
        snapshot: [
        ...
        policy: `<ul>
            <li>Sustainable Waste Management Act (2022) <a class='cite-link' href='../references/#ref-sustainable-waste-management-act-2022-kenya' title='Source: Republic of Kenya – Sustainable Waste Management Act'>↗</a></li>
    ...
    "rwanda": {
        overviewText: "Rwanda is widely regarded as Africa's model for waste prohibition and environmental discipline, driven by strong governance, public compliance, and ambitious circular economy targets that extend far beyond its pioneering 2008 plastic bag ban. With Kigali generating approximately 292,000 tons of waste annually (75% organic), Rwanda has developed comprehensive systems that other African nations study and replicate. <a class='cite-link' href='../references/#ref-integrated-solid-waste-management-strategy' title='Source: REMA – Integrated Solid Waste Management Strategy'>↗</a> The country's recent waste management achievements include the homegrown SHINE Model—a locally-developed, cost-efficient solid waste management framework created in 2024-2025 by GIZ in partnership with Rwanda's Ministry of Environment, successfully piloted in Bugesera, Rwamagana, and Muhanga districts. <a class='cite-link' href='../references/#ref-the-shine-model-sustainable-cost-efficient-waste-management' title='Source: GIZ – The SHINE Model'>↗</a> Rwanda operates Enviroserve Rwanda Green Park, Africa's second state-of-the-art e-waste dismantling facility, which has trained 70 young Rwandans and created 413 green jobs while providing services across Uganda, DRC, and Burundi. <a class='cite-link' href='../references/#ref-the-contribution-of-e-waste-recycling-in-promoting-green-growth-a-case-of-enviro' title='Source: Iraguha & Uwimpuhwe – E-Waste Recycling in Rwanda'>↗</a> The country's innovative Plastic Waste Management Fund (established 2021) has collected nearly 1,500 tonnes from 24 drop-off points while creating 1,300 green jobs. Rwanda's streets feature plastic roads constructed from recycled waste, offering durable alternatives to traditional asphalt. The National Circular Economy Action Plan and Roadmap sets an ambitious vision: transforming Kigali into a zero-waste city by 2035 while achieving 100% Extended Producer Responsibility (EPR) compliance by 2030. <a class='cite-link' href='../references/#ref-national-circular-economy-action-plan' title='Source: REMA – National Circular Economy Action Plan'>↗</a> With political will, community behavior change programs, and comprehensive e-waste management systems, Rwanda demonstrates how strong governance coupled with practical innovation can create world-class environmental outcomes.",
        snapshot: [
        ...
        treatment: `<ul>
            <li>Integrated Solid Waste Management Strategy (2022) <a class='cite-link' href='../references/#ref-integrated-solid-waste-management-strategy' title='Source: REMA – Integrated Solid Waste Management Strategy'>↗</a></li>
    ...
    "south-africa": {
        ...
        policy: `<ul>
            <li>National Environmental Management: Waste Act <a class='cite-link' href='../references/#ref-national-environmental-management-waste-act' title='Source: DFFE – National Environmental Management: Waste Act'>↗</a></li>
            <li>Extended Producer Responsibility (EPR) Regulations</li>
            <li><strong>Draft National Waste Management Strategy (NWMS) 2026:</strong> Released for public comment, outlining next-generation targets for waste diversion, circular economy, and equitable service delivery <a class='cite-link' href='../references/#ref-draft-national-waste-management-strategy-2026' title='Source: DFFE – Draft NWMS 2026'>↗</a></li>
            <li>Mandatory producer compliance schemes</li>
            <li><strong>Africa Circular Economy Alliance (ACEA) Founding Member (2022):</strong> South Africa co-leads regional circular economy initiatives alongside African Union, World Economic Forum, and World Bank <a class='cite-link' href='../references/#ref-africa-circular-economy-alliance-acea-framework' title='Source: ACEA Framework'>↗</a></li>
        </ul>`,
        challenges: [
...
const countryDataFr = {
    "nigeria": {
        ...
        wasteGeneration: `<p>Le Nigéria génère environ <strong>32 millions de tonnes métriques</strong> de déchets solides par an, les zones urbaines contribuant pour environ <strong>27,3 millions de tonnes</strong> par an. Ce chiffre devrait atteindre <strong>107 millions de tonnes d'ici 2050</strong>. <a class='cite-link' href='../references/#ref-what-a-waste-2-0-a-global-snapshot-of-solid-waste-management-to-2050' title='Source: World Bank – What a Waste 2.0'>↗</a></p>
    ...
    "egypt": {
        ...
        policy: `<ul>
            <li><strong>Loi de Réglementation de la Gestion des Déchets (Loi n° 202 de 2020)</strong> <a class='cite-link' href='../references/#ref-waste-management-regulation-law-no-202-of-2020-egypt' title='Source: Egyptian Ministry of Environment – Law No. 202'>↗</a></li>
    ...
    "kenya": {
        ...
        policy: `<ul>
            <li>Loi sur la Gestion Durable des Déchets (2022) <a class='cite-link' href='../references/#ref-sustainable-waste-management-act-2022-kenya' title='Source: Republic of Kenya – Sustainable Waste Management Act'>↗</a></li>
    ...
    "rwanda": {
        ...
        treatment: `<ul>
            <li>Stratégie Intégrée de Gestion des Déchets Solides (2022) <a class='cite-link' href='../references/#ref-integrated-solid-waste-management-strategy' title='Source: REMA – Integrated Solid Waste Management Strategy'>↗</a></li>
    ...
    "south-africa": {
        overviewText: "L'Afrique du Sud possède l'économie des déchets la plus industrialisée d'Afrique, générant environ 54 millions de tonnes de déchets par an, soutenue par une législation avancée comprenant la Loi Nationale sur la Gestion de l'Environnement : Déchets, les cadres de Responsabilité Élargie des Producteurs (REP) et des régimes complets de conformité des producteurs. <a class='cite-link' href='../references/#ref-national-environmental-management-waste-act' title='Source: DFFE – National Environmental Management: Waste Act'>↗</a> Le pays dispose des systèmes REP les plus sophistiqués d'Afrique — en particulier pour les déchets électroniques et les polymères — avec des programmes de récupération de polymères détournant plus de 430 000 tonnes de plastique des décharges chaque année. Pourtant, malgré ces atouts, l'Afrique du Sud fait face à de profondes inégalités : 37 % des ménages (environ 9,8 millions de personnes) n'ont pas accès à des services d'enlèvement des ordures, en particulier dans les zones rurales et les établissements informels. <a class='cite-link' href='../references/#ref-draft-national-waste-management-strategy-2026' title='Source: DFFE – Draft NWMS 2026'>↗</a> En tant que membre fondateur de l'Alliance Africaine pour l'Économie Circulaire (ACEA) créée en 2022 aux côtés de l'Union Africaine, du Forum Économique Mondial, de la Banque Africaine de Développement et de la Banque Mondiale, l'Afrique du Sud détient un leadership continental dans l'élaboration des politiques et des cadres d'investissement de l'économie circulaire. <a class='cite-link' href='../references/#ref-africa-circular-economy-alliance-acea-framework' title='Source: ACEA Framework'>↗</a>",
        snapshot: [
        ...
        policy: `<ul>
            <li>Loi Nationale sur la Gestion de l'Environnement : Déchets <a class='cite-link' href='../references/#ref-national-environmental-management-waste-act' title='Source: DFFE – National Environmental Management: Waste Act'>↗</a></li>
            <li>Règlements sur la Responsabilité Élargie des Producteurs (REP)</li>
            <li><strong>Projet de Stratégie Nationale de Gestion des Déchets (NWMS) 2026 :</strong> Publié pour commentaires publics, décrivant des objectifs de nouvelle génération pour le détournement des déchets, l'économie circulaire et la prestation équitable de services <a class='cite-link' href='../references/#ref-draft-national-waste-management-strategy-2026' title='Source: DFFE – Draft NWMS 2026'>↗</a></li>
            <li>Régimes obligatoires de conformité des producteurs</li>
            <li><strong>Membre Fondateur de l'Alliance Africaine pour l'Économie Circulaire (ACEA) (2022) :</strong> L'Afrique du Sud co-dirige les initiatives régionales d'économie circulaire <a class='cite-link' href='../references/#ref-africa-circular-economy-alliance-acea-framework' title='Source: ACEA Framework'>↗</a></li>
        </ul>`,
        challenges: [
